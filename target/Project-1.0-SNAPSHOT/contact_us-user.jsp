<%-- 
    Document   : contact_us
    Created on : 22 Dec 2025, 11:09:03 am
    Author     : arash
--%>
        ...
        <!-- Each Job Card -->
          ...
          <div class="col-md-6" style="text-align: center;background-color: aquamarine;">
                    <form method="post" action="contactUs">
                         <h2>contact Us</h2> <br> 
                         <input type="text" placeholder="Enter Name" class="reglog_tf_design" name="name1" value="<jsp:expression>name</jsp:expression>"/><br> <br>
                    <input type="text" placeholder="Enter Email" class="reglog_tf_design" name="email1" value="<jsp:expression>email</jsp:expression>"/><br> <br>
